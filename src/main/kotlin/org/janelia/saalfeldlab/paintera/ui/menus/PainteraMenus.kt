...
private val versionedSourceMenu by lazy { Menu("_Versioned", null, CLONE_VERSIONED_PROJECT_SOURCE.menu,NEW_VERSIONED_LABEL_SOURCE.menu,OPEN_VERSIONED_LABEL_SOURCE.menu) }
