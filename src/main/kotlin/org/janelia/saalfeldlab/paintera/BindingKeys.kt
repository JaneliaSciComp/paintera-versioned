...
object PainteraBaseKeys {
    ...
    const val CREATE_VERSIONED_LABEL_DATASET   = "create new versioned label dataset"
    const val CLONE_VERSIONED_PROJECT          = "clone versioned project"
    const val OPEN_VERSIONED_LABEL_DATASET     = "open versioned project"
