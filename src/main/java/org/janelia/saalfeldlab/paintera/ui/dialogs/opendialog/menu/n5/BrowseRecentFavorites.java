...
public class BrowseRecentFavorites {
  ...
  public static MenuButton menuButton(
	  ...
	  final MenuItem showBranchesButton = new MenuItem("_Show Branches");
	  ...
	  return new MenuButton(name, null, browseFoldersButton, browseFilesButton, versionedRepoButton,showBranchesButton,recentMatcher, favoritesMatcher);
