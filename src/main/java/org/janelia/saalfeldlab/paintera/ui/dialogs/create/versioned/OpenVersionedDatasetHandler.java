...
public class OpenVersionedDatasetHandler {
	...
	private static void createAndAddNewLabelDataset(
		...
		final OpenVersionedDataset cd = new OpenVersionedDataset(currentSource, Arrays.stream(allSources).map(pbv.sourceInfo()::getState).toArray(SourceState[]::new));
